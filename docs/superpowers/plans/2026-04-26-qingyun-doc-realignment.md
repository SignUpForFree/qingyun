...
**数据来源：** spec §2.5 指向 `轻运AI需求文档(1).docx` 章节 3.1.3，`/tmp/qy-doc/full.txt:329-1438` 已抽出 100 支签的纯文本（签号 / 等级 / 签题 / 签诗 / 6 维度解读）。
