...
/**
 * 鉴权 proxy 测试（Next.js 16 起 middleware 重命名为 proxy；V2 弹窗登录）
 *
 * V2 起页面路由不再 redirect，由 LoginGate（client）触发 Sheet 弹窗；
 * proxy 只负责放行公开前缀，私有 API 拦截为 401 JSON。
 */
