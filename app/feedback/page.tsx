 ...
 *   - 邮件入口（mailto，最低门槛）
 *   - 反馈类型说明（建议/缺陷/内容偏离）
 *   - 体验承诺（看完每一条 + 不会向第三方共享反馈）
 *
 * V1.1 改为后台接 /api/feedback 表单提交。
 */
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pb-20">
        <GlassCard className="space-y-3 p-5 text-center">
          ...
          <p className="text-xs leading-relaxed text-[var(--color-ink-fade)]">
            轻运 AI 是 1 人 5 周做出来的 MVP，肯定有不少粗糙地方。
            <br />
            写一行也算，吐槽不会丢。
          </p>
          <Divider />
          <a
            ...
            className="inline-block rounded-[8px] bg-gradient-to-r from-[#F0B8C8] to-[#C9A1D9] px-5 py-2 text-sm tracking-ritual text-white shadow-pill hover:opacity-90"
          >
            写一封邮件 →
          </a>
